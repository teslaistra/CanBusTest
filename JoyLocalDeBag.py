...
class X360:
    ...
    axis_map = []
    button_map = []
    xthreshold = 8 * 0x10000 / 128 #4096 in dec
    ythreshold = 8 * 0x10000 / 128 #4096 in dec
    ...
    def usb_joystick_read_thread(self, jsdev):
        ...
        while rnet_threads_running:
            print ("I'm thread #3 - reading from USB")
            try:
                evbuf = jsdev.read(8)
...
def send_joystick_canframe(s,joy_id):
    ...
    while rnet_threads_running:
        print ("I'm thread #1 - sending x and y")
...
def inject_rnet_joystick_frame(can_socket, rnet_joystick_id):
    ...
    while rnet_threads_running:
        ...
        print ("I'm thread #3 - sending x and y")
